...
from ..rmq import RabbitMQConnection  # Assuming you have a RabbitMQConnection class defined
from ..my_logging import Log  # Assuming you have a Log class defined
